...
DBIDE.Templates.Files = '''
  <li class='folder'><img class='folder-icon' src='<%= expanded ? "/images/open.png" : "/images/closed.png" %>'><%= path.display_name() %> <img class="new-file pull-right" style="vertical-align:-1px;" src="/images/plus.png"></li>
  <ul class='files'></ul>
'''
